 ...
 *
 * TODO(Max): move this to a library in the Connector Manager.
...
public class ConnectorFields {
   ...
   */
  protected abstract static class AbstractField implements Field {
   ...
   */
  protected static class SingleLineField extends AbstractField {
   ...
   * default value.
   */
  protected static class IntField extends SingleLineField {
   ...
   * will be preselected.
   */
  protected static class EnumField<E extends Enum<E>> extends AbstractField {
